...
<nav class="lg:hidden fixed bottom-0 w-full bg-white border-t border-passion-pink-200 z-50 flex justify-around items-center pb-safe pt-2 h-16">
    <a href="/" class="flex flex-col items-center p-2 text-passion-red hover:text-passion-fire-orange transition-colors group">
        <!-- Icon Home -->
    ...
    <a href="/allos" class="flex flex-col items-center p-2 text-gray-400 hover:text-passion-red transition-colors group relative">
        <!-- Icon Fire -->
        <div class="absolute -top-1 right-2 w-3 h-3 bg-passion-fire-orange rounded-full animate-pulse"></div>
