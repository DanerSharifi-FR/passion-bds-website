...
(function () {
            ...
            tailwind.config = {
                theme: {
                    extend: {
                        ...
                        colors: {
                            passion: {
                                pink: { 100: '#FFF0F5', 200: '#FCE2EC', 300: '#F9D7E5', 400: '#F4BBD2', 500: '#E4476A' },
                                fire: { orange: '#FF914D', yellow: '#FFC94A' },
                                red: '#9B1237',
                            },
                            cr: {
                                common: '#8daebf',
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (isIndex) {
      // Homepage interactions (machine, QCM, rain, etc.) from index.html
    ...
    if (isGallery) {
      // Gallery page: rain animation + events pagination
              // --- RAIN ANIMATION (From Homepage) ---
              const icons = ['📸', '🖼️', '🎞️', '✨', '🔥', '💖'];
              const container = document.getElementById('rain-container');
              function createRain() {
                  const count = 10;
              ...
              // --- DATA (Edit this section for real content) ---
